...
// ─── Adresses V2 (Arc mainnet — déployé le 2026-09-21, V1 fees + création gratuite) ──
export const ARC_FACTORY_V2_ADDRESS  = "0xc46539460b23dCA11D4D13cb2f873eD7c38a0a85" as `0x${string}`;
export const ARC_CURVE_V2_IMPL       = "0xAb48705F6EAF17E9c7540ee76dEFe304d077E257" as `0x${string}`;
export const ARC_VAULT_V4_IMPL       = "0x3A3af98c3E2bbd5d7C08a118A74255dEd39A8C1f" as `0x${string}`;
