...
const translationEntries: Array<[string, string]> = [
  ...
  ["My Predictions", "Mes prédictions"],
  ...
  ["Website · octomarket.fun", "Site web · octomarket.fun"],
  ["X / Twitter · @octomarketfun", "X / Twitter · @octomarketfun"],
  ...
  ["No live predictions are open in this section yet. Add a new market from the admin panel and it will appear here automatically.", "Aucune prédiction en direct n’est encore ouverte dans cette section. Ajoutez un nouveau marché depuis le panneau admin et il apparaîtra ici automatiquement."],
  ...
  ["Connect wallet", "Connecter le wallet"],
  ["No predictions recorded yet.", "Aucune prédiction enregistrée pour le moment."],
