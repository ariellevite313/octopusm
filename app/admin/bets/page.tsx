...
export const metadata: Metadata = { title: "Predicts Validation — Admin" };
...
export default async function AdminBetsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Predicts Validation</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          {bets.length} predict{bets.length !== 1 ? "s" : ""} pending review
        </p>
      </div>
