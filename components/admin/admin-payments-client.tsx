          ...
          <div className="space-y-3 text-sm">
            ...
            <div>
              ...
              <select
                ...
                value={manual.flow}
                onChange={(e) => setManual((m) => ({ ...m, flow: e.target.value as typeof MANUAL_FLOWS[number] }))}
              >
            ...
            <div>
              ...
              <input
                className="w-full rounded-xl border border-border bg-card px-3 py-2 font-mono text-xs focus:outline-none focus:ring-2 focus:ring-orange-400"
            ...
            <Button
              className="w-full rounded-xl bg-orange-500 text-white hover:bg-orange-400"
              disabled={manualLoading}
              onClick={submitManual}
            >
              {manualLoading ? <LoaderCircle className="size-4 animate-spin mr-2" /> : null}
              Save Payment
            </Button>
          </div>
        </DialogContent>
