    ...
    <SheetPortal>
      ...
      >
        ...
        <button
          ...
          className="ring-offset-background focus:ring-ring absolute right-4 top-4 z-20 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none"
